...
config="$repo_root/configs/basicvsrpp/mosaic_restoration_generic_stage2.20_large_roi_native_tiles.py"
default_work_dir="/Volumes/Project_HD/lada_finetune_aozora_hikari/basicvsrpp_clean_no_interlace_fc2_v3/stage-04-large-roi-native-tiles-projreward0035-orth0015-9000-seed20260817"
work_dir="${WORK_DIR:-$default_work_dir}"
max_iters="${MAX_ITERS:-9000}"
val_interval="${VAL_INTERVAL:-500}"
checkpoint_interval="${CHECKPOINT_INTERVAL:-250}"
max_keep_ckpts="${MAX_KEEP_CKPTS:-37}"
...
print(f"MPS large-ROI backend: mps-deform-conv {version}")
PY
