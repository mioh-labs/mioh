...
# PyTorch 2.6+ defaults torch.load to weights_only=True. MMEngine checkpoints
# created by this project include HistoryBuffer in their trusted local metadata.
...
def parse_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        help=(
            'Allow full loading of a checkpoint generated by this project. '
            'Do not use with checkpoints from an untrusted source.'
        ),
    )
