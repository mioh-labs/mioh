...
final class RemoteControlServer: ObservableObject {
  ...
  private func validate(
    ...
    guard (value.restorationEngine == nil
      ...
      (0...30).contains(value.swiftVRFrameSmoothing ?? 15),
