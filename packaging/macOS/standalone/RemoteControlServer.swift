...
private enum RemoteControlHTML {
  static let page = #"""
    ...
    const settingTabs=[
      ...
      ['processing',[
        ['並列処理',[['parallelWorkers','並列数','number',1,16,1],['executor','実行方式','select','executors']]],
