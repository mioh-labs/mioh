"""Conservative non-GAN polish after full-generator GAN reactivation.

Stage A reactivated the complete BasicVSR++ generator with 26-frame RGB
discrimination and VGG supervision.  This stage deliberately turns those
distribution losses off again and updates only the established reconstruction
tail on the recoverable-HF/FC2 curriculum.  The known mosaic forward operator,
ROI fidelity, temporal consistency and high-frequency losses are identical to
the promoted forward-consistency continuation.
"""
...
experiment_name = 'mosaic_restoration_generic_stage2.15_full_gan_conservative_tail'
experiment_root = (
    '/Volumes/Project_HD/lada_finetune_aozora_hikari/'
    'basicvsrpp_full_gan_reactivation'
)
work_dir = experiment_root + '/stage-b-conservative-v1-seed20260814'

initialization_checkpoint = (
    experiment_root
    + '/stage-b-initialization/stage-a-500-ema-as-generator.pth'
)
train_manifest = (
    '/Volumes/Project_HD/lada_finetune_aozora_hikari/'
