"""Fresh 500-step extension of the selected cumulative-1000 EMA model.

The model-only Stage 2.12 EMA checkpoint is used as both the raw and EMA
initial state.  A distinct training seed avoids replaying either earlier
500-step sample/augmentation sequence.  Local iterations 250 and 500
correspond to cumulative continuation points 1250 and 1500 respectively.
"""
...
experiment_name = 'mosaic_restoration_generic_stage2.13_forward_consistency_1500'
work_dir = f'./experiments/basicvsrpp/{experiment_name}'

initialization_checkpoint = (
    '/Volumes/Project_HD/lada_finetune_aozora_hikari/'
    'forward_consistency_stage2_12/deployment/'
...
randomness = dict(seed=20260810, deterministic=True)
