"""Bounded detail recovery from the adopted clean-4000 restoration model."""
...
experiment_name = "mosaic_restoration_generic_stage2.19_clean_detail_recovery"
experiment_root = (
...
work_dir = (
    experiment_root
    + "/stage-03-detail-recovery-projreward0035-orth0015-1500-seed20260817"
)
...
train_cfg = dict(type="IterBasedTrainLoop", max_iters=1500, val_interval=250)
